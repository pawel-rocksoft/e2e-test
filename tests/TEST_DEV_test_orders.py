...
def test_DE_order_klarna():
    ...
    driver.get("https://storefront:horze123@hrzde.horze.io/vollbesatzreithosen-fuer-damen/horze-active-damen-vollbesatzreithose-mit-silikon-grip/36277.html")
...
def test_DE_order_amazon():
    ...
    driver.get("https://storefront:horze123@hrzde.horze.io/sattelkammer-zubehoer/horze-stabiler-sattelhalter/50000.html")
...
def test_NO_order_klarna_paylater():
    ...
    driver.get("https://storefront:horze123@www.hrzno.horze.io/allround--sprangsjabraker/horze-chooze-allround-sjabrak/17000.html")
...
def test_NO_order_paypal():
    ...
    driver.get("https://storefront:horze123@www.hrzno.horze.io/helforsterkede-ridebukser-til-dame/horze-active-helforsterket-dameridebukse-med-silikon/36277.html")
...
def test_FI_order_klarna():
    ...
    driver.get("https://storefront:horze123@hrzfi.horze.io/hevostarvikkeet-ratsastustarvikkeet---horze.fi/horze-gift-card/98000.html")
...
def test_FI_order_paypal():
    ...
    driver.get("https://storefront:horze123@hrzfi.horze.io/naisten-ratsastushousut-kokopaikoilla/horze-active--naisten-ratsastushousut-silikonipainatetuilla-kokopaikoilla/36277.html")
...
def test_AT_order_klarna():
    ...
    driver.get("https://storefront:horze123@hrzat.horze.io/andere-ergaenzungen/trikem-vimital-zink-500g/323922.html")
...
def test_SE_order_paypal():
    ...
    driver.get("https://storefront:horze123@hrzse.horze.io/helskodda-ridbyxor-foer-dam/horze-active-silikonhelskodda-damridbyxor/36277.html")
...
def test_EU_order_paypal():
    ...
    driver = webdriver.Chrome('C:\\WebDrivers\\chromedriver.exe', options = options)
    wait = WebDriverWait(driver, 10)
    driver.get("https://storefront:horze123@hrzeu.horze.io/womens-full-seat-breeches/horze-active-womens-silicone-grip-full-seat-breeches/36277.html")
...
def test_WW_order_paypal():
    ...
    driver = webdriver.Chrome('C:\\WebDrivers\\chromedriver.exe', options = options)
    wait = WebDriverWait(driver, 10)
    driver.get("https://storefront:horze123@hrzww.horze.io/womens-full-seat-breeches/horze-active-womens-silicone-grip-full-seat-breeches/36277.html")
...
def test_PL_order_P24():
    ...
    driver = webdriver.Chrome('C:\\WebDrivers\\chromedriver.exe', options = options)
    wait = WebDriverWait(driver, 10)
    driver.get("https://storefront:horze123@hrzpl.horze.io/bryczesy-z-pelnym-lejem-damskie/bryczesy-damskie-z-pelnym-lejem-silikonowym-horze-active/36277.html")
...
def test_UK_order_paypal():
    ...
    driver = webdriver.Chrome('C:\\WebDrivers\\chromedriver.exe', options = options)
    wait = WebDriverWait(driver, 10)
    driver.get("https://storefront:horze123@hrzuk.horze.io/womens-full-seat-breeches/horze-active-womens-silicone-grip-full-seat-breeches/36277.html")
...
def test_UK_order_CC():
    ...
    driver.get("https://storefront:horze123@hrzuk.horze.io/stands-racks/horze-durable-saddle-rack/50000.html")
...
def test_FR_order_PayPal():
    ...
    driver.get("https://storefront:horze123@hrzfr.horze.io/pantalon-dequitation-grip---femme/pantalon-dequitation-taille-haute-horze-tara-silicone-fond-integral-femme/36091.html#color=VDB")
...
def test_NL_order_iDEAL():
    ...
    driver.get("https://storefront:horze123@hrznl.horze.io/dames-full-seat-rijbroeken/horze-active-siliconen-grip-full-seat-rijbroek-dames/36277.html#color=BL")
    wait = WebDriverWait(driver, 10)
    driver.maximize_window()
...
def test_CH_order_klarna():
    ...
    driver.get("https://storefront:horze123@hrzch.horze.io/vollbesatzreithosen-fuer-damen/horze-active-damen-vollbesatzreithose-mit-silikon-grip/36277.html")
...
def test_HU_order_PayPal():
    ...
    driver.get("https://storefront:horze123@hrzhu.horze.io/egyeb-etrendkiegeszítok-lovaknak/trikem-vimital-zinc-500g/323922.html")
...
def test_ES_order_PayPal():
    ...
    driver.get("https://storefront:horze123@hrzes.horze.io/capas-base-mujer/camisa-de-mangas-cortas-funcional-para-mujer-horze-mathilde/33522.html#color=MSBE")
